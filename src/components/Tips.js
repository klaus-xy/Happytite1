  ...
  return (
    <div className="tips">
      <div className="right">
        ...
        <ul>
          <li>
            <span>Limit processed foods and added sugars:</span>Processed foods
            and added sugars can be high in calories, unhealthy fats, and
            sodium, which can contribute to weight gain and chronic diseases.
